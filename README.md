...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/workerpagecloudflare)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/workerpagecloudflare
```

A live public deployment of this template is available at [https://workerpagecloudflare.templates.workers.dev](https://workerpagecloudflare.templates.workers.dev)
